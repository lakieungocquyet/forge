...
if [ -f "$CLINVAR_FILE_PATH" ]; then
    ...
    logger WARN "skip clinvar annotation (file not found)"
...
if [ -f "$PHASE3_1000G_V4_20130502_FILE_PATH" ]; then
    ...
    logger WARN "skip 1000g phase3 annotation (file not found)"
...
if [ -f "$DBSNP_138_FILE_PATH" ]; then
    ...
    logger WARN "skip dbsnp138 annotation (file not found)"
...
if [ -f "$DBNSFP_FILE_PATH" ]; then
    ...
    logger WARN "skip dbnsfp annotation (file not found)"
